...
When called from the CLI, returns a string:
...
When called as a scriptor with arguments, returns an array of strings.
...
When called as a script, returns an array of objects.
